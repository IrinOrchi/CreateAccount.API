...
namespace CreateAccount.Handler.Service
{
    ...
    {
        private readonly IRLRepository _repository;
        private readonly IValidator<RLNoRequestDTO> _validator;

        public RLNoHandler(IRLRepository repository, IValidator<RLNoRequestDTO> validator)
        {
        ...
        public async Task<RLNoResponseDTO> Handle(RLNoRequestDTO dto)
        {
            ...
            var data = await _repository.GetRLNoDataAsync(dto.RLNo);
